...
- **some course notes** mostly taken by hand & ***useful to myself only however***. For memories only
...
## Resources worth checking when taking Data science MOOCs
...
### 5. Python programming + working with databases
